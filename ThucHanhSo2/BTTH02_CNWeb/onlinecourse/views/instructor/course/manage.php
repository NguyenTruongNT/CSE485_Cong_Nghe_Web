    ...
    <style>
        ...
        * {
        ...
        .search-box .filter-group>label {
            ...
            visibility: hidden;
            height: 14px;
            /* chiều cao tương đương label khác */
            margin-bottom: 8px;
            /* margin tương đương label khác */
        }
                            ...
                            <div class="course-card">
                                ...
                                <div class="course-footer">
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        <a href="#" class="action-btn delete-btn" title="Xóa khóa học"
                    ...
                    <?php if (isset($totalPages) && $totalPages > 1): ?>
                        <div class="pagination">
                            ...
                            <?php if ($currentPage > 1): ?>
                                <a href="<?php echo $queryPrefix; ?>page=<?php echo $currentPage - 1; ?>" class="pagination-btn">
                            ...
                            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                ...
                                <?php else: ?>
                                    <a href="<?php echo $queryPrefix; ?>page=<?php echo $i; ?>" class="page-number">
                                        <?php echo $i; ?>
                                    </a>
                                <?php endif; ?>
                            <?php endfor; ?>
