...
<body>
            ...
            <div class="content-area">
                ...
                <div class="welcome-banner">
                    <div class="welcome-content">
                        ...
                        <p>Chào mừng trở lại bảng điều khiển giảng viên. Dưới đây là tổng quan về hoạt động giảng dạy
                            của bạn.</p>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="course-title-cell">
                                                    <span
                                                        class="course-title"><?php echo htmlspecialchars($course['title']); ?></span>
                                                    <span
                                                        class="course-category"><?php echo htmlspecialchars($course['category_name'] ?? 'Chưa phân loại'); ?></span>
                                                </div>
                                            </td>
                                            <td><?php echo htmlspecialchars($course['category_name'] ?? 'Chưa phân loại'); ?>
                                            </td>
                                            <td>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.action-btn, .btn-view-all, .btn-logout, .btn-view-home, .quick-action-card')
                .forEach(element => {
