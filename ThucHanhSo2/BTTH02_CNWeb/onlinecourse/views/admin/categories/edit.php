...
// Dữ liệu cần: $category (chi tiết danh mục)
$category = $category ?? [];
    ...
    <div class="admin-layout">
        ...
        <main class="admin-content">
            <div class="content-header">
                <h1><i class="fas fa-edit"></i> Chỉnh sửa Danh mục:
                    <?php echo htmlspecialchars($category['name'] ?? 'N/A'); ?>
                </h1>
                <p>Cập nhật thông tin chi tiết cho danh mục.</p>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo BASE_URL; ?>/admin/updateCategory/<?php echo $category['id'] ?? ''; ?>"
                        method="POST">
