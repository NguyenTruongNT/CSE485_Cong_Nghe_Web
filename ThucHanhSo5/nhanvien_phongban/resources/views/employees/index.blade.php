...
<body class="bg-light">
    <div class="container mt-5">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('employees.create') }}" class="btn btn-success">Thêm nhân viên mới</a>
        </div>

        <form action="{{ route('employees.index') }}" method="GET" class="mb-3 d-flex">
                ...
                <tbody>
                    @foreach($employees as $emp)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('employees.show', $emp->id) }}" class="btn btn-sm btn-info">Xem</a>
